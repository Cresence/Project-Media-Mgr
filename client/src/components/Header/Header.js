  ...
  <div className="carousel-inner">
    <div className="carousel-item active">
      ...
      <div className="carousel-caption">
        ...
        <p><a href="/detail" id="ph1" className="btn btn-theme more-detail" >See More Detail</a></p>
      </div>   
    </div>
    <div className="carousel-item">
      ...
      <div className="carousel-caption">
        ...
        <p><a href="/detail" id="ph2" className="btn btn-theme more-detail">See More Detail</a></p>
      </div>   
    </div>
    <div className="carousel-item">
      ...
      <div className="carousel-caption">
        ...
        <p><a href="/detail" id="ph3" className="btn btn-theme more-detail">See More Detail</a></p>
      </div>   
    </div>
    <div className="carousel-item">
      ...
      <div className="carousel-caption">
        ...
        <p><a href="/detail" id="ph4" className="btn btn-theme more-detail">See More Detail</a></p>
      </div>   
    </div>
  </div>
